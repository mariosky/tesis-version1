...
managed in a scheme of a relational database. Technical support about
instalations of dependencies and the application are explained in
appendix section.
...
are depicted in figure \ref{fig:fis-inputs}. The (\ref{fig:fis-
inputs}.a) and(\ref{fig:fis-inputs}.b) are in a range from 0 to 1 to
...
the weight for expert recommendation list, figure (\ref{fig:fis-
outputs}.b) represents the weight of the content-based list and figure
...
the recommendation lists are reduced when filter context is applied,
