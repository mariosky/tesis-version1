...
%%
%% Esta parte no es del método
%% Es de la implementación del caso de estudio
...
the language of the consumer is often imprecise, with attributes 
values expressed in fuzzy terms. 
