...
to compare several recommender techniques. 
%% No debemos ser didácticos sobre lo que se tiene que hacer, 
%% en tu tesis usas este conocimiento, pero no lo debes explicar.
%% Cambialo a algo que no explique, por ejemplo:
%%
...
An off-line experiment is performed by using a pre-collected dataset
...
%% Datasets?? esto está en la sección pasada
\section{Datasets} 
...
technology most often used by them. The \textit{questionnaire} consisted of \textit{8
questions} and also they were asked to rate any number of restaurants from a list of 40 restaurants.
Each of the restaurants chosen, was rated 6 times one per proposed context, a
matrix rating with \textit{1,422 ratings} was collected. The
...
\setlength\fboxsep{0pt}
%\setlength\fboxrule{0.7pt}
\fbox{\includegraphics[width=0.50\textwidth]{img/context-ml.png}}
